            ...
            <div class="table-responsive">
              <table class="table align-items-center mb-0">
                ...
                <?php if (empty($peminjaman)): ?>
                  <tr>
                    <td colspan="7" class="text-center text-muted">Tidak ada pinjaman yang melewati jatuh tempo 🎉</td>
                  </tr>
                <?php else: ?>
                  <?php foreach ($peminjaman as $i => $p): ?>
                    <tr>
                      ...
                      <td><strong class="text-danger"><?= rupiah($p['denda_berjalan']) ?></strong></td>
