...
if (isset($_POST['simpan'])) {
    ...
    $query = "INSERT INTO `buku`(`cover`,`judul_buku`, `kode_buku`, `isbn`, `nama_penulis`, `tahun_terbit`, `penerbit`) VALUES ('$cover','$judul_buku','$kode_buku','$isbn','$nama_penulis','$tahun_terbit','$penerbit')";
